...
@Composable
fun KihonKumiteDetailScreen(technik: KarateTechnik, onNavigateBack: () -> Unit, isFavorite: Boolean, onToggleFavorite: (KarateTechnik) -> Unit){
        ...
        Column (
            ...
            Row(
                ...
                Surface(
                    ...
                    Text(
                        text = technik.kihonKumite?.kihonKumite ?: "Unbekannt",
                        color = MaterialTheme.colorScheme.primary,
